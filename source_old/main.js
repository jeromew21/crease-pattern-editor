...
class Triangle extends CanvasObject {
    static count = 0;
    constructor(x, y, theta, l1, l2, rotation, parent) {
        super(x, y);
        // SAS (side-angle-side)
        this.parent = parent;
...
class Canvas {
    constructor(canvas) {
        ...
        this.square = new Square(500, 500, 0, 0);
        ...
        bindCheckbox(this.ui.circle.show, this.circles.show, 
            function () { self.circles.show = true; }, 
            function () { self.circles.show = false; });

        bindCheckbox(this.ui.paper.show, this.square.show,
            function() { self.square.show = true; },
            function() { self.square.show = false; });
    ...
    createTile(tileType) {
        ...
        var t = new Triangle(this.square.x + hw + r1, this.square.y + hw + r2, theta, l, l, 0, this)
        this.objects.push(t);
        this.updateObjects();
    }
